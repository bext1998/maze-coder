...
- [ ] AC-11：canonical skills、public skills、internal skills 數量分別為 22、19、3，Router 只增加兩個公開 review 入口。
- [ ] AC-12：`SPEC_REVIEW.md` 納入文件模型與根 template 同步。
- [ ] AC-13：adaptive scenarios 共 11 個，PR review 改用新入口且新增 spec review 情境。
